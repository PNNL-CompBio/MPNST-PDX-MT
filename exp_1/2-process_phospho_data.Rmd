...
data_package_num <- 5793
data_folder <- "data/phospho_data"
crosstab_prefix <- "Chr8_UMN1"
path_to_global_crosstab <- "data/global_data/Chr8_UMN1_crosstab_global_gene_original.txt"
...
path_to_FASTA_gene <- remap_accessions_uniprot_to_gene_fasta(fst_dms_pth)
