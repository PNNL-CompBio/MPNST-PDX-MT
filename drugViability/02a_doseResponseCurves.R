...
musyc.scores <- read.csv("musyc_20250804.csv")
...
write.csv(musyc.scores, "Deconvolved_musyc_20250804.csv", row.names=FALSE) # duplicated and changed name to musyc.csv for synapse
musyc.scores <- read.csv("Deconvolved_musyc_20250804.csv")
